...
DESCRIPTION:anthy = "A Japanese input method (backend, dictionary and utility)"
DESCRIPTION:libanthy0 = "Anthy runtime library"
DESCRIPTION:libanthy-dev = "Anthy static library, headers and documets for developers"
