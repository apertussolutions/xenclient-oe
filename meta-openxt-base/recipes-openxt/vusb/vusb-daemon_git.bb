...
# project.h defines globals in the header; GCC defaults to -fno-common.
# udev.c snprintf format-truncation is promoted by -Werror under GCC 15.
CFLAGS:append = " -fcommon -Wno-error=format-truncation"
