...
DEPENDS = "libxenmgr-core libxchutils libxchv4v libxchxenstore libxchdb xenclient-rpcgen-native xenclient-idl xen-tools ghc-native ghc-json ghc-hsyslog ghc-regex-posix ghc-network libxch-rpc ghc-attoparsec ghc-zlib ghc-parsec ghc-deepseq ghc-text ghc-mtl"
RDEPENDS_${PN} += "glibc-gconv-utf-32 xenclient-eula ghc-runtime xenclient-caps heimdallr openxt-toolstack-data"
